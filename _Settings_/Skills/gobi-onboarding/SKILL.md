...
### 언어 설정
- **`.gobi/settings.yaml`의 `primaryLanguage`를 확인하고, 사용자가 처음 말한 언어로 온보딩 전체를 진행한다.** 사용자가 영어로 시작하면 끝까지 영어로, 한국어로 시작하면 끝까지 한국어로 진행한다.
...
4. **볼트 열기**: 사용자가 옵시디언에서 직접 볼트를 열도록 안내한다 (고비 데스크탑과 나란히 사용).
